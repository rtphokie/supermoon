...
def main(dt, moons=1, year=None, perigee=False, distance=False, angulardiameter=True):
    lines = []
...
* TimeandDate.com (Norwegian company offering website and data services on 
  ...
  https://www.timeanddate.com/astronomy/moon/super-full-moon.html
    ...
    parser.add_argument('-A', '--angulardiameter', action='store_const', default=True, const=True,
    ...
    if args.year is None:
        lines = main(dt=None, moons=args.cnt, perigee=args.perigee, distance=args.distance, angulardiameter=args.angulardiameter)
        if args.cnt < 1:
